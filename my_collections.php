        ...
        <div class="listing_grid">
            ...
            <div class="listing_grid--item">
                <div class="listing_grid--item-img">
                    <a href="single-place.php?place_id=<?php echo $collection['place_id']; ?>"
                ...
                <div class="listing_grid--item-content">
                    ...
                    <a class="listing_grid--item-content_name"
                        href="single-place.php?place_id=<?php echo $collection['place_id']; ?>">
                        <?php echo htmlspecialchars($collection['name']); ?>
                    </a>
                    <a href="<?php echo htmlspecialchars($collection['google_map_location']); ?>"
                    ...
                    <div class="listing_grid--item-content_stars">
                        <?php
                                ...
                                $percentage = ($rating / 5) * 100;
                                    $review_count = isset($collection['total_reviews']) ? (int)$collection['total_reviews'] : 0;


                                ?>
                        <div>
                            <div class="listing_grid--item-content_stars-stars" style="background: linear-gradient(90deg, #A21111 var(--rating, <?php echo $percentage; ?>%), #D0D0D0 var(--rating, <?php echo $percentage - 100; ?>%)); 
