...
<head>
    <!-- last man alive  last women alive last child alive  -->
    <meta charset="UTF-8">
    ...
    <nav>
        <nav class="navbar">
            <div class="navbar_container">
                <div class="navbar_container--menu-L"><a href="./index.html">home</a><a href="./blogs.html">blog</a><a
                        href="#">categories</a><a href="#">about us</a></div>
                ...
                <div class="navbar_container--menu-R"><a class="btn__red--m btn__red btn" id="search-btn" href="#"><i
                        ...
                        href="#">sign up</a><a class="btn__red--m btn__red btn" href="./add-place.html">add
                        place</a>
                </div>
            </div>
        </nav>
        ...
        <div class="LogOverlay">
            <div class="LogOverlay__content">
                ...
                <div class="LogOverlay__content--signup">
                    <div class="LogOverlay__content--signup_role"><a class="btn__red--l btn__red btn"
                            href="#">Guest</a><a class="btn__transparent--l btn__transparent btn" href="#">Owner</a>
                    </div>
