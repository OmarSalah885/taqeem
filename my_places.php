...
$places_query = $conn->prepare("
    SELECT p.id, p.name, p.price, p.tags, p.city, p.address, p.featured_image, p.google_map_location, 
    ...
    <div class="places_likes">
        <div class="pageinfo">
            <div class="pageinfo_content">
                <h2><?php echo $is_owner ? 'My Places' : htmlspecialchars($user['first_name'] . ' ' . $user['last_name']) . '\'s Places'; ?></h2>
            </div>
        </div>
                    ...
                    <div class="listing_grid--item">
                        <div class="listing_grid--item-img">
                            <a href="single-place.php?place_id=<?php echo $place['id']; ?>" class="listing_grid--item-img_img">
                                <img src="<?php echo htmlspecialchars($place['featured_image'] ?? 'assets/images/listing.jpg'); ?>" alt="<?php echo htmlspecialchars($place['name']); ?>">
                            </a>
