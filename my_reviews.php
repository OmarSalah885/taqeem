...
// Debug: Log number of reviews fetched
error_log("Reviews fetched for user_id=$user_id, page=$page: " . $reviews_result->num_rows);
...
<main class="my_rev">
    ...
    <div class="places_likes_content">
        <?php if ($reviews_result->num_rows === 0): ?>
            <p class="no-reviews">No reviews found for <?php echo $is_owner ? 'you' : htmlspecialchars($user_name); ?>.</p>
        <?php else: ?>
            <div class="listing_grid">
                <?php while ($review = $reviews_result->fetch_assoc()): ?>
                    ...
                    if (isset($_SESSION['user_id'])) {
                        ...
                        $check_like_query->bind_param("ii", $current_user_id, $review['review_id']);
                    ...
                    <div class="activity_grid--item">
                        ...
                        <div class="activity_grid--item_content">
                            ...
                            <p class="review-text">
                                <?php echo htmlspecialchars(substr($review['review_text'], 0, 200)); ?>
