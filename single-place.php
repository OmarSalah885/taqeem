...
<main class="place">
    ...
    <div class="place_CONTACT">
        ...
        <div class="place_CONTACT--info">
            <div class="place_CONTACT--info-item">EMAIL: <a href="#">example.user@example.com</a></div>
            <div class="place_CONTACT--info-item">WEBSITE: <a href="#">www.theHungryForks.com</a></div>
            <div class="place_CONTACT--info-item">PHONE(1): <a href="#">+1 (555) 987-6543</a></div>
            <div class="place_CONTACT--info-item">PHONE(2): <a href="#">+1 (555) 123-4567</a></div>
        </div>
            ...
            <div class="review">
                <div class="review_profile">
                    ...
                    <div class="review_profile--info">
                        <a href="#" class="review_profile--info-name">abd
                            ulrhman alshafee</a>
                ...
                <div class="review_btns">
                    <a class="review_btns--like" href="#"><i class="fa-regular fa-heart"></i></a>
                    <a class="review_btns--link" href="#">edit my review</a>
                    <a class="review_btns--link" href="#">comment on review</a>
                </div>
                <textarea name="" id="" placeholder="add comment on review"></textarea>
                <div class="review_placeComment">
                    <h4>place owner commented</h4>
                    <p>
                        Thank you so much for this wonderful review! We're thrilled to hear that you enjoyed your
                        experience at The Hungry Fork. It's always our goal to bring a taste of the sea to Rainbow
                        Street, and we're delighted the Crispy Calamari, Garlic Butter Shrimp, and Grilled Sea Bass hit
                        the mark. Our team works hard to create a warm, welcoming atmosphere and serve dishes that leave
                        a lasting impression, so your kind words truly mean a lot to us. We’re especially glad you
                        enjoyed the Mango Sorbet—it's a staff favorite too! Looking forward to welcoming you back soon
                        for another delicious seafood experience.
                    </p>
    ...
    <div class="addReview">
        ...
        <div class="addReview_container">
            ...
            <a class="btn__transparent--s btn__transparent btn" href="#">add photos</a>
